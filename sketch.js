...
ground1=new Ground(655,275,230,20);
ground2 = new Ground(600,550,1201,35);
...
//area2
box17 = new Box(565,245,30,40);
box18 = new Box(595,245,30,40);
box19 = new Box(625,245,30,40);
box20 = new Box(655,245,30,40);
box21 = new Box(685,245,30,40);
box22 = new Box(715,245,30,40);
box23 = new Box(745,245,30,40);
box24 = new Box(595,205,30,40);
box25 = new Box(625,205,30,40);
box26 = new Box(655,205,30,40);
box27 = new Box(685,205,30,40);
box28 = new Box(715,205,30,40);
box29 = new Box(625,145,30,40);
box30 = new Box(655,145,30,40);
box31 = new Box (685,145,30,40);
box32 = new Box (655,105,30,40);
